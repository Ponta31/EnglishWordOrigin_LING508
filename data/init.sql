...
VALUES
    (1, 'adjective', '突然の', 'The car came to an abrupt stop.'),
    (2, 'verb', '正式に取り消す', 'The government decided to revoke the license.'),
    (3, 'verb', '遊ぶ、演奏する', 'The children play in the park.'),
    (3, 'noun', '演劇、遊び', 'They watched a play at the theater.');
;
